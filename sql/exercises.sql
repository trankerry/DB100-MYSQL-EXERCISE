...
SELECT
 ...
 payment_date
FROM payment
WHERE payment_date >= '2005-5-27' AND payment_date <= '2005-5-28';
...
SELECT 
 ...
 payment_date
FROM payment
WHERE DATE(payment_date) IN ('2005-5-25', '2005-5-27', '2005-5-29');
...
SELECT * FROM payment WHERE payment_date BETWEEN '2005-5-25 00:00:00' and '2005-5-25 23:59:59';
